...
def deploy_token_farm_and_dapp_token(front_end_update=False):
    ...
    tx.wait(1)
    # Start with 3 different tokens: dapp_token, weth_token, fau_token (faucet token/dai)
...
def update_front_end():
    """Sending the front end of our config in JSON format and also
